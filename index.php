                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contacts__feed">
                            <?php echo do_shortcode( '[contact-form-7 id="124" title="Rewiew"]' ) ?>
                        </div>
                    </div>
                </div>
                <div class="row mt70">
